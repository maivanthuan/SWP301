 ...
 * @author thuan
 */
public class RevenueProductServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
    throws ServletException, IOException {
        String chart_raw = request.getParameter("chart");
        InvoiceProductDAO dal = new InvoiceProductDAO();
...
//        request.setAttribute("total", total);
        request.getRequestDispatcher("productRevenue.jsp").forward(request, response);
    } 
}
