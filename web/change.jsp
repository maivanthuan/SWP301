<%-- 
    Document   : change
    Created on : May 19, 2024, 11:50:01 PM
    Author     : Admin
--%>
...
<html>
    ...
    String avata  = khachHang.getAvata();
            ...
            <div class="container">
                ...
                <form class="form" action="UserController" method="post" enctype="multipart/form-data">
                    <input  type="hidden" name="hanhDong" value="changeInfor">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                <img src="<%=avata%>" alt="Image Description"  style="width: 200px;">
                                <br>
                                <!--						<label for="avata" class="form-label">Change avatar</label> <input
                                                                                        type="file" class="form-control" id="avata" name="avata" value="<%=avata%>">-->
