<%-- 
    Document   : adminproductpurchasehistory
    Created on : Jun 30, 2024, 12:13:45 AM
    Author     : Clownfool
--%>
...
<html>
    ...
    <body>
        ...
        <h5>Chọn ngày:</h5>
        <form action="purchaseDetailServlet" method="get">
            ...
            <tbody>
                <c:forEach var="history" items="${purchaseHistories}">
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-secondary" onclick="window.location.href = '${pageContext.request.contextPath}/purchaseDetailServlet?totalInvoiceProductID=${history.totalInvoiceProductID}&hanhdong=chitiet'">Chi tiết</button>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
